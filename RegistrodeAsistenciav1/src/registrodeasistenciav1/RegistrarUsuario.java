...
public class RegistrarUsuario extends javax.swing.JFrame {
    ...
    void registrar_usuario(){
     String sql="INSERT INTO usuarios (nombre, edad, sexo, cargo, area, usuario, contrasenia, acceso) VALUES(?,?,?,?,?,?,?,?)" ;
        try{       
        ...
        pst.setString(8,cbx_acceso.getSelectedItem().toString());
    ...
    private void initComponents() {
        ...
        cbx_acceso.setBackground(new java.awt.Color(102, 0, 0));
        cbx_acceso.setForeground(new java.awt.Color(204, 204, 204));
